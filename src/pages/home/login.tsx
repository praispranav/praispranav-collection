...
function Input({ placeholder, type, value, onChange }: any) {
  return <input type={type} className="auth-input form-control  py-3" value={value} onChange={onChange} placeholder={placeholder} />;
}
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="mx-2">
              ...
              <button type="button" onClick={submit} className="btn form-control login-btn btn-primary">
                Login
              </button>
            </div>
